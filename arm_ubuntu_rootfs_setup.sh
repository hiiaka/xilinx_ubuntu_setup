...
sudo wget http://cdimage.ubuntu.com/ubuntu-base/releases/20.04/release/ubuntu-base-20.04.2-base-armhf.tar.gz
sudo tar xf ubuntu-base-20.04.2-base-armhf.tar.gz
sudo rm ubuntu-base-20.04.2-base-armhf.tar.gz
sudo sync
cd ${UHOME}
