...
sudo wget http://cdimage.ubuntu.com/ubuntu-base/releases/18.04/release/ubuntu-base-18.04.5-base-armhf.tar.gz
sudo tar xf ubuntu-base-18.04.5-base-armhf.tar.gz
sudo rm ubuntu-base-18.04.5-base-armhf.tar.gz
sudo sync
cd ${UHOME}
